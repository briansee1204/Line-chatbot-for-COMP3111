...
public class KitchenSinkTester {
	...
	public void test_case3() throws Exception {
		...
		String result = null;
		try {
			result = this.databaseEngine.search("I say one two three four.");
		} catch (Exception e) {
			thrown = true;
		}
		assertThat(!thrown).isEqualTo(true);
		assertThat(result).isEqualTo("You say one two three four.");
	...
	public void test_case4() throws Exception {
		...
		String result = null;
		try {
			result = this.databaseEngine.search("123");
		} catch (Exception e) {
			thrown = true;
		}
		assertThat(!thrown).isEqualTo(true);
	...
	public void test_case5() throws Exception {
		...
		assertThat(!thrown).isEqualTo(true);
		assertThat(result).isEqualTo("Bye. See you.");
